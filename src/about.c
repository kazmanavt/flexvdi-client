...
void client_show_about(GtkWindow * parent, ClientConf * conf) {
    GdkPixbuf * logo = gdk_pixbuf_new_from_resource("/com/paralax/images/logo-client.png", NULL);
    ...
    gtk_show_about_dialog(parent,
        "title", "About paralax",
        "logo", logo,
        "program-name", "paralax",
        "version", version,
        "comments", desc,
        "copyright", "© 2021 complicated",
        "license-type", GTK_LICENSE_GPL_3_0,
        "website", "nowhere",
        "website-label", "nowhere",
        NULL);
}
